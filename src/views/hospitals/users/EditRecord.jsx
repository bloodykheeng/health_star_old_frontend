...
function EditRecord({ hospitalData, show, onHide, onClose, rowData }) {
  ...
  const handleSubmit = async (data) => {
    ...
    formData.append('hospital_id', hospitalData?.id);
    formData.append('health_facilities', hospitalData?.health_facilities);
